            ...
            <form method="get" class="form-inline">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        ...
                        <a href="{{url('log')}}" class="btn btn-default"><i class="fa fa-refresh"></i></a>
                    </span>
                </div>
            </form>
        </div>
        <a href="{{url('log/clear')}}" class="btn btn-danger">HAPUS SEMUA LOG</a>
        <hr>
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if ($k->kecamatan)
                        <a href="{{url('kecamatan/'.$k->kecamatan_id)}}">{{ $k->kecamatan->nama }}</a>
                        @endif
                    </td>
                    <td>
                        @if ($k->kelurahan)
                    ...
                    <td class="text-right">
                        ...
                        {!! Form::open(['method' => 'DELETE', 'url' => url('log/'.$k->id), 'style' => 'display:none;', 'id' => 'delete-log-'.$k->id]) !!}
