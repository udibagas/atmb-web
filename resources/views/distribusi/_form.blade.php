...
{!! Form::model($distribusi, ['class' => 'form-horizontal form-label-left', 'url' => $url, 'method' => $method]) !!}
    ...
    <div class="form-group{{ $errors->has('tanggal') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::text('tanggal', $distribusi->tanggal, ['class' => 'form-control  col-md-7 col-xs-12', 'placeholder' => 'yyyy-mm-dd']) }}
    ...
    <div class="form-group{{ $errors->has('jumlah') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::number('jumlah', $distribusi->jumlah, ['class' => 'form-control  col-md-7 col-xs-12', 'placeholder' => 'Jumlah (Liter)']) }}
    ...
    <div class="form-group{{ $errors->has('nama_petugas') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::text('nama_petugas', $distribusi->nama_petugas, ['class' => 'form-control  col-md-7 col-xs-12', 'placeholder' => 'Nama Petugas']) }}
    ...
    <div class="form-group{{ $errors->has('telpon_petugas') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::text('telpon_petugas', $distribusi->telpon_petugas, ['class' => 'form-control  col-md-7 col-xs-12', 'placeholder' => 'Telpon Petugas']) }}
    ...
    <div class="form-group{{ $errors->has('keterangan') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::textarea('keterangan', $distribusi->keterangan, ['class' => 'form-control  col-md-7 col-xs-12', 'placeholder' => 'Keterangan', 'rows' => 3]) }}
    ...
    <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            ...
            <a href="{{url('distribusi')}}" class="btn btn-default">BATAL</a>
        </div>
    </div>
